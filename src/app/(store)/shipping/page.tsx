    ...
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <div className="prose-nest mt-6">
        ...
        <ul className="list-disc space-y-2 pl-5 text-ink/70">
          <li>
            Orders <strong className="text-ink">₹{commerce.free_shipping_threshold} and above</strong>: free shipping
          </li>
          <li>
        ...
        <h2>Timelines</h2>
        <p>
          Most orders dispatch within 1-3 business days. Delivery usually takes 4-10 business
          days depending on your pincode and courier partners. You will receive updates on
          the contact details shared at checkout.
        </p>
      </div>
    </div>
  );
